				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name">{{ $data2->data->name }}</h2>
							{{-- <div>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-12">
                        ...
                        <!-- product -->
                        @forelse ($data1->data->company_product as $item2)
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="d-flex justify-content-center row">
                            <div class="col-md-12">
                                @forelse ($data1->data->company_merchandise as $item1)
                                <div class="row p-2 bg-white border rounded">
                                    <div class="col-md-3 mt-1"><img class="img-fluid img-responsive rounded product-image" src="{{ $item1->image }}"></div>
                                    <div class="col-md-6 mt-1">
                                        <h4>{{ $item1->name }}</h4>
                                        <div class="d-flex flex-row">
                                            {{-- <div class="ratings mr-2"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i></div><span>310</span> --}}
                                        </div>
                                        <p class="text-justify text-truncate para mb-0">DESC: {{ $item1->description }}<br><br></p>
                                    </div>
                                    <div class="align-items-center align-content-center col-md-3 border-left mt-1">
                                        <div class="d-flex flex-row align-items-center">
                                            <h4 class="mr-1">RM{{ $item1->price }}</h4>
                                        </div>
