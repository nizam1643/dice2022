                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10 col-xl-8">
                        <div class="hero-txt text-center white-color">
                            ...
                            <!-- Title -->
                            <h2 class="h2-xs">Pre-Registeration</h2>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 col-xl-8">
                    <div class="section-title title-01 mb-70">
                        ...
                        <!-- Title -->
                        <h2 class="h2-sm">Get Ready for New Adventure</h2>

                        <!-- Text -->
                        <p class="p-xl">It is important that you notify your supervisor before filling out the pre-registration form. This will allow them to be aware of the request and give their approval if necessary.
                        </p>
