...
<html lang="en">
	<head>
		...
		<link rel="icon" href="{{ asset('front/HTML/images/favicon.icoHTML/') }}" type="image/x-icon">
		<link rel="apple-touch-icon" sizes="152x152" href="{{ asset('front/HTML/images/apple-touch-icon-152x152.pngHTML/') }}">
		<link rel="apple-touch-icon" sizes="120x120" href="{{ asset('front/HTML/images/apple-touch-icon-120x120.pngHTML/') }}">
		<link rel="apple-touch-icon" sizes="76x76" href="{{ asset('front/HTML/images/apple-touch-icon-76x76.pngHTML/') }}">
		<link rel="apple-touch-icon" href="{{ asset('front/HTML/images/apple-touch-icon.pngHTML/') }}">
		<link rel="icon" href="{{ asset('front/HTML/images/apple-touch-icon.pngHTML/') }}" type="image/x-icon">
